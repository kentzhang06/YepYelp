    ...
    return(
      <div>
        ...
        <div className="all-ratings">
          <div className={`review-5star`} id='select-review' onClick={() => this.toggleRating(5)}>
          </div>
          <div className={`review-4star`} id='select-review' onClick={() => this.toggleRating(4)}>
          </div>
          <div className={`review-3star`} id='select-review' onClick={() => this.toggleRating(3)}>
          </div>
          <div className={`review-2star`} id='select-review' onClick={() => this.toggleRating(2)}>
          </div>
          <div className={`review-1star`} id='select-review' onClick={() => this.toggleRating(1)}>
          </div>
        </div>
        <div className="review-forms-container">
          ...
          <div className={`review-${this.state.rating}star`} id="chosen-rating">
          </div>
